...
<p align="center">
  <img src="assests/pipeline.pdf" alt="ReLAR Pipeline" width="700"/>
</p>
...
| **ReLAR (Ours)** | **77.67 / 72.54** | 68.45 / 78.23 | **41.06 / 45.58** | **57.50 / 75.23** |
...
## Ablation Summary (Table 4, Gemma-2B on PubMedQA)
